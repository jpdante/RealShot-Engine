...
#include "../../Source/Editor/Views/ProjectManager/ProjectItem.h"
...
QT_INIT_METAOBJECT const QMetaObject ProjectItem::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_ProjectItem.data,
